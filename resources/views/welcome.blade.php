...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
                    ...
                    <form action="/login" method="post">
                        ...
                        <div class="formlogin">
                            {{-- <div class="" style="display: flex; gap: 10px">
                                <p>DOMAIN GET : </p>
                                <input type="text" name="domain_get" placeholder="Company Key" style="border: 1px solid #000; border-radius: 6px; padding-left: 5px">
                            </div>

                            <div class="" style="display: flex; gap: 10px">
                                <p>DOMAIN WS : </p>
                                <input type="text" name="domain_ws" placeholder="Company Key" style="border: 1px solid #000; border-radius: 6px; padding-left: 5px">
                            </div>

                            <div class="" style="display: flex; gap: 10px">
                                <p>DOMAIN SEAMLESS : </p>
                                <input type="text" name="domain_seamless" placeholder="Company Key" style="border: 1px solid #000; border-radius: 6px; padding-left: 5px">
                            </div>
                            
                            <div class="" style="display: flex; gap: 10px">
                                <p>DOMAIN REVERB : </p>
                                <input type="text" name="domain_reverb" placeholder="Company Key" style="border: 1px solid #000; border-radius: 6px; padding-left: 5px">
                            </div> --}}
        ...
        <script>
            const env_get = @json(env('GET_URL'));
            const env_ws = @json(env('WS_URL'));
            const env_semaless = @json(env('URL_SEAMLESS'));
